...
const Footer: React.FC = () => {
    return (
        <div className='bg-black-velvet mt-44 py-14 px-40'>
            <div className='grid grid-cols-6'>
                ...
                <ul className='grid grid-rows-5 gap-3'>
                    ...
                    <li className='text-gray-9 cursor-pointer'>Gernes</li>
                ...
                <ul className='grid grid-rows-2'>
                    ...
                    <ul className='grid grid-cols-3 justify-center'>
                        ...
                        <li><svg width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='flex justify-between items-center text-gray-9'>
                <div>
